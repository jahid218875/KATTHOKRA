            ...
            <div class="col-md-12 py-5">
                <form class="mx-auto" style="width: 400px">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control form-control-lg login-input border-0"
                    ...
                    <div class="mb-3">
                        ...
                        <select id="inputState" class="form-select border-0 my-1 login-input form-control-lg py-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="institution" class="form-control  form-control-lg login-input border-0"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control form-control-lg login-input border-0 fs-6"
                            id="exampleInputinstitution1">
                    </div>
