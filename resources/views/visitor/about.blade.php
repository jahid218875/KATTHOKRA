...
<section class="container px-3 pb-5">
    ...
    <h1 class="text-center fw-bold py-5">আমাদের লক্ষ<span class="text-success"> ও উদ্দেশ্য</span></h1>

    <div class="row">
        <div class="col-md-12">
            <p class="px-5 text-justyfi" style="text-align: justify">
                জাতি হিসেবে আমরা আত্মিক উন্নতির চেয়ে উদরপূর্তির প্রতি বেশি মনোযোগী এ কথা সকলেরই জানা! বিশ্ববিদ্যালয়
                ...
                হলে নজরকাড়া নাম্বর পাওয়া দুরূহ! আর মাস্টারমশাইরাও শিক্ষার্থীদের কোর্সের উপর দক্ষতা যাচাই অপেক্ষা
                পুস্তকে প্রাপ্ত প্রশ্নের উত্তর যাচাই করার প্রতি বেশি মনোযোগী। তাদের এহেন তাড়াহুড়ো করার পেছনেও ওই একই
                কারণ- উদরপূর্তি।

                <br><br>যত তাড়াতাড়ি সার্টিফিকেট নামক মূল্যবান কাগজ পাওয়া যায় উদরপূর্তির বন্দোবস্তও ততই দ্রুত করা
                সম্ভব।
                ...
                <br><br>এর পেছনে অনেক কারণ থাকলেও একটি মুখ্য কারণ নিয়ে আমরা কেউই চিন্তিত নই। উচ্চমাধ্যমিক পর্যন্ত
                মাতৃভাষায়
                ...
                <br><br>সেখানে মাতৃভাষায় উচ্চশিক্ষার ব্যবস্থা করলে যে আমরা চীন জাপানের চেয়ে কোন অংশে আমরা পিছিয়ে
                থাকতাম না
                - এ
                বিষয়ে মনে হয় সবাই একমত হবেন। অল্প সময়ের মধ্যেও শিক্ষার্থীরা বুঝে পড়ার সুযোগ পেত, উপরন্ত গবেষণা খাতে
