                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('admin.engineering_subject_process')}}"
                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.engineering_subject_edit', $sub_list->id)}}"
                                        onclick="return confirm('are you sure?')" class="badge bg-success">Edit</a>
                                </td>
                                <td>
                                    <a href="{{ route('admin.engineering_subject_delete', $sub_list->id)}}"
