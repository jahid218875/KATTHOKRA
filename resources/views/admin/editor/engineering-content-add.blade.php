                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Engineering Content Add</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('editor.engineering_content_submit')}}"
...
<script>
 ...
 var subject = $(this).val();
  ...
  $.ajax({
     type:'POST',
     url:"{{ route('editor.engineering_chapter_process') }}",
     data:{
...
$("#chapter").change(function(e){
 ...
 var chapter = $(this).val();
  ...
  $.ajax({
     type:'POST',
     url:"{{ route('editor.engineering_type_process') }}",
     data:{
        '_token': $('input[name=_token]').val(),
        chapter_id: chapter
    },
