                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Engineering Type Add</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('admin.engineering_type_submit')}}" method="post"
                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.engineering_type_delete', $type_list->id)}}"
...
<script>
 ...
 var subject = $(this).val();
  ...
  $.ajax({
     type:'POST',
     url:"{{ route('admin.engineering_type_process') }}",
     data:{
